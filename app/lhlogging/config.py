...
AIRLINE_CALLSIGN_PREFIX: str = _optional("AIRLINE_CALLSIGN_PREFIX", "DLH")
...
# Flight detection
STATE_POLL_INTERVAL_MINUTES: int = int(_optional("STATE_POLL_INTERVAL_MINUTES", "2"))
FLIGHT_DETECT_LOOKBACK_MINUTES: int = int(_optional("FLIGHT_DETECT_LOOKBACK_MINUTES", "60"))
LANDING_VELOCITY_THRESHOLD_MS: float = float(_optional("LANDING_VELOCITY_THRESHOLD_MS", "30.0"))
LANDING_ALTITUDE_THRESHOLD_M: float = float(_optional("LANDING_ALTITUDE_THRESHOLD_M", "300.0"))
MISSED_DEPARTURE_ALTITUDE_M: float = float(_optional("MISSED_DEPARTURE_ALTITUDE_M", "3000.0"))
MISSED_DEPARTURE_DISTANCE_KM: float = float(_optional("MISSED_DEPARTURE_DISTANCE_KM", "100.0"))
MISSED_DEPARTURE_MAX_GAP_H: int = int(_optional("MISSED_DEPARTURE_MAX_GAP_H", "48"))
